<?php $__env->startSection('content2'); ?>
    ...
    <div class="container text-center mb-3 py-3">
        ...
        <?php endif; ?>
        <!-- Balance -->
        <h2 class="fw-medium"> <?php echo e(number_format(auth()->user()->balance, 2)); ?> <small><?php echo e($general->site_currency); ?></small>
        </h2>
                ...
                <div class="card border-0 mb-4 theme-blue bg-radial-gradient text-white">
                    <div class="card-body bg-none">
                        <div class="row gx-2 align-items-center">
                            ...
                            <div class="col">
                                <p class="small mb-1"><?php echo e(__('Total Withdraw')); ?></p>
                                <h5><?php echo e(number_format($withdraw, 2)); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 mb-4 theme-green bg-radial-gradient text-white">
                    <div class="card-body bg-none">
                        <div class="row gx-2 align-items-center">
                            ...
                            <div class="col">
                                <p class="small mb-1"><?php echo e(__('Total Deposit')); ?></p>
                                <h5><?php echo e(number_format($totalDeposit, 2)); ?></h5>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 mb-4 theme-orange bg-radial-gradient text-white">
                        <div class="card-body bg-none">
                            <div class="row gx-2 align-items-center">
                                ...
                                <div class="col">
                                    <p class="small mb-1"><?php echo e(__('Profit Log')); ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
