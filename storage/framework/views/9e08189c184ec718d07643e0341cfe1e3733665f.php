        ...
        <nav class="navbar fixed-top">
            <div class="container-fluid">
                ...
                <div class="ms-auto">
                    <div class="row">
                        <div class="col-auto">
                            <a href="https://wa.me/<?php echo e($general->whatsapp_number); ?>" type="button" class="btn btn-square btn-link text-center"
                                ...
                                <a class="dd-arrow-none dropdown-toggle" id="userprofiledd" data-bs-toggle="dropdown"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                            <p class="mb-0">
                                                <span
                                                    class="text-dark username"><?php echo e(@Auth::user()->fname . ' ' . @Auth::user()->fname); ?></span><br>
                                            </p>
                                        </div>
                                        <div class="col ps-0 align-self-center d-none d-lg-block">
                                    ...
                                    <div class="dropdown-info bg-radial-gradient-theme">
                                        <div class="row">
                                            ...
                                            <div class="col align-self-center ps-0">
                                                ...
                                                <p class="text-muted small">Balance:  <?php echo e(number_format(auth()->user()->balance, 2)); ?> </p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="container">
                ...
                <div class="row text-center collapse " id="usersidebarprofile">
                    ...
                    <div class="col-12 mb-4">
                        <h6 class="mb-1" id="usernamedisplay"><?php echo e(@Auth::user()->fname . ' ' . @Auth::user()->fname); ?></h6>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    <div class="col-12 px-0">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="<?php echo e(url('ticket')); ?>">
                                    <div class="avatar avatar-40 icon"><i class="bi bi-house-door"></i></div>
